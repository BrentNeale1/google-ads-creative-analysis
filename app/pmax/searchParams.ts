...
export const pmaxSearchParams = createSearchParamsCache({
  ...
  to: parseAsIsoDate,
  /** Campaign ID filter (PMax has no adGroup -- uses asset groups instead) */
...
export type PmaxTab = "overview" | "assets" | "recommendations";
